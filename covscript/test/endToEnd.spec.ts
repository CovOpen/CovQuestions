...
describe("Generator/Parser End-To-End Tests", () => {
  ...
  expectE2E('"test" in [1, 2, 3, 4 + 2 - 3, 5]', '"test" in [1, 2, 3, 4 + 2 - 3, 5]');
  expectE2E('1 > 0 AND 7 - 2 % 3 == 1 OR "Test" != Test', '1 > 0 and 7 - 2 % 3 == 1 or "Test" != Test');
  ...
  expectE2E("round (q_contact_date + v_two_days)", "round (q_contact_date + v_two_days)");

  expectE2E("log10 (q_contact_date + v_two_days)", "log10 (q_contact_date + v_two_days)");
});
