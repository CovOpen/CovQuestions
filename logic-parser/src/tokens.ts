...
export const False = createToken({ name: 'False', pattern: /false|False|FALSE/ })
...
export const If = createToken({ name: 'If', pattern: /if|IF|If/, categories: Keyword })
export const Then = createToken({ name: 'Then', pattern: /then|THEN|Then/, categories: Keyword })
export const Else = createToken({ name: 'Else', pattern: /else|ELSE|Else/, categories: Keyword })
export const EndIf = createToken({ name: 'EndIf', pattern: /endif|ENDIF|EndIf/, categories: Keyword })

export const Comma = createToken({ name: 'Comma', pattern: /,/ })
export const Add = createToken({ name: 'Add', pattern: /\+/, categories: AdditionOperator })
export const Sub = createToken({ name: 'Sub', pattern: /-/, categories: AdditionOperator })

export const Mult = createToken({ name: 'Mult', pattern: /\*/, categories: MultiplicationOperator })
...
export const GreaterEqual = createToken({ name: 'GreaterEqual', pattern: />=/, categories: ComparisonOperator })
export const LessEqual = createToken({ name: 'LessEqual', pattern: /<=/, categories: ComparisonOperator })
export const Equal = createToken({ name: 'GreaterEqual', pattern: /==/, categories: ComparisonOperator })
export const NotEqual = createToken({ name: 'LessEqual', pattern: /!=/, categories: ComparisonOperator })
export const Negation = createToken({ name: 'Negation', pattern: /!/, categories: UnaryOperator })
