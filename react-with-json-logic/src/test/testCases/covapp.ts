...
You can find more information in the data protection declaration.`,
  ...
  variables: [
    ...
    },
    {
      ...
      value: {
        or: [{ var: "q13_cough.value" }, { var: "q15_sore_throat.value" }, { var: "q16_breath.value" }],
      },
    },
  ],
  resultCategories: [
      ...
      results: [
        {
          ...
          value: {
            and: [{ var: "v_symptoms.value" }, { var: "v_contact.value" }, { var: "v_symptoms_after_contact.value" }],
          },
        },
        {
          id: "MEDIUM_RISK_A",
          text: "Typical symptoms of SARS-Cov-2 without contact.",
          value: { and: [{ var: "v_symptoms.value" }, { var: "v_respiratory_symptoms.value" }] },
        },
        {
          id: "MEDIUM_RISK_B",
          text: "No symptoms, but contact with case.",
          value: { and: [{ var: "v_contact_relevant.value" }, { "!": { var: "v_symptoms.value" } }] },
        },
        {
          id: "LOW_RISK",
        ...
        },
        {
          id: "NO_RISK",
          text: "No risk",
          value: { and: [{ "!": { var: "v_symptoms.value" } }, { "!": { var: "v_contact.value" } }] },
        },
      ],
    },
    {
