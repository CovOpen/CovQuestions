...
const testQuestionnaire: Questionnaire = {
  ...
  questions: [
    ...
    },
    {
      id: "q3_caring",
      text:
        "At least once a week, do you privately care for people with age-related conditions, chronic illnesses, or frailty?",
      type: "boolean",
    },
    {
      id: "q4_work",
    ...
    },
    {
      ...
      details:
        "The question relates to acute or exacerbated symptoms and excludes chronic complaints or seasonal or allergic complaints. If you have a chronic illness, compare your current symptoms with your previous problems to answer the question.\n\nIf you don't have any of the symptoms, don't select an entry and continue by choosing the \"Next\" button.",
    },
    {
      id: "q13_cough",
      ...
      type: "boolean",
      details:
        "The question relates to cold symptoms and excludes chronic cough, seasonal or allergy-related cough.\nIf you have a chronic cough, compare your current coughing to your regular problems.",
    },
    {
      id: "q14_runny_nose",
      ...
      type: "boolean",
      details:
        "The question relates to cold symptoms and excludes chronic runny nose, seasonal or allergy-related runny nose. If you have chronic sniffling, compare your current conditions with your existing problems.",
    },
    {
      id: "q15_sore_throat",
    ...
    },
    {
      ...
      details:
        "You take or get immunosuppresives after an organ transplant, in the therapy of an autoimmune disease, or during chemotherapy.",
    },
    {
      id: "q24_vaccines",
    ...
    },
    {
      ...
      type: "text",
      details:
        "You can enter your postal code here. By specifying your postal code, you allow us to map the data you donated on a map of Germany. This enables us further understand the spread of the pandemic.",
    },
  ],
  variables: [
    {
