...
describe("questionnaireEngine", () => {
  ...
  it("should add scores between different questions", () => {
    ...
    expect(dataObject[question1Id].score).toEqual({ scoreId1: 1, scoreId2: 2 });
    expect(dataObject[question2Id].score).toEqual({ scoreId1: 4, scoreId3: 8 });
    expect(dataObject.score).toEqual({ scoreId1: 5, scoreId2: 2, scoreId3: 8 });
  });
});
