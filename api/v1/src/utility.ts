...
export function readI18nFile(path: string): { source: TranslationMap; target: TranslationMap; lang: string } {
  ...
  (xliff.file.body["trans-unit"] as TransUnit[]).forEach((translation) => {
    transMapSource[translation["@id"]] = translation.source["$"] || translation.source["#"];
    transMapTarget[translation["@id"]] = translation.target["$"] || translation.target["#"];
  });
...
export function replaceTranslationMap(map: TranslationMap, replacementMap: TranslationMap): TranslationMap {
